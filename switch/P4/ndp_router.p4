...
action decreasereg() {
    register_read(meta.register_tmp, buffersense, standard_metadata.egress_port);
    register_write(buffersense, standard_metadata.egress_port, meta.register_tmp-1 + standard_metadata.egress_priority);
}
action cont() {
}
...
action setpriolow() {
    ...
    register_read(meta.register_tmp, buffersense, standard_metadata.egress_port);
    register_write(buffersense, standard_metadata.egress_port, meta.register_tmp+1);
}
